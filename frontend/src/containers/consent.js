    ...
    return (
      <div>
        <p>
          ...
          agree to all of these terms, do not use this website.</strong>
        </p>
        <p>
        ...
        <p>
          <strong>Note:</strong> <em>We use our best efforts to provide accurate information
          regarding the diagnosis or treatment of feeding issues, and providers
          of any services related to feeding and swallowing; however, we make no
