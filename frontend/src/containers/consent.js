  ...
  return (
    <div>
      <p>
        ...
        carefully. By accessing or using this Website, you agree to be bound by
        the terms and conditions described herein and all terms, policies,
      ...
      <p>
        ...
        click on "I agree" at the bottom of this window to continue the provider
        search.
      </p>
      <p>
        <strong>Note:</strong>{' '}
        <em>
          We use our best efforts to provide accurate information regarding the
          diagnosis or treatment of feeding issues, and providers of any
          ...
          safety of its services. You should thoroughly investigate any provider
          from whom you are considering engaging services. Do not rely on the
          information published on this Website for medical advice. Neither the
          company nor the Website provides medical advice. The content of this
