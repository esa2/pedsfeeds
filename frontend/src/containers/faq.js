  ...
  render() {
    return (
      <div>
        ...
        <ul>
          <li>
            This may be your pediatrician, family care doctor, or a specialist
            in gastroenterology (GI), otolaryngology, pulmonology, or
            rehabilitation.
          </li>
        </ul>
        <p>
        ...
        <p>
          ...
          solutions offered to families. This community of practice evolved out
        ...
        <p>
          ...
          happy to help you establish a local chapter. The PedsFeeds.com
          directory is currently open to licensed professionals in the United
          States only.
        </p>
        <p>
